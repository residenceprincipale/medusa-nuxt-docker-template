...
export class Migration20260819212227 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table if not exists "post" ("id" text not null, "title" text not null, "handle" text not null, "content" text not null, "excerpt" text null, "author" text not null, "published_at" timestamptz null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "post_pkey" primary key ("id"));`);
